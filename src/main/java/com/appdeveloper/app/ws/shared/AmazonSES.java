...
public class AmazonSES {
	...
	final String FROM = "ozlemkaradeniz@gmail.com";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ "<a href='http://localhost:8080/good-reader-email-verify/email-verification.html?token=$tokenValue'>"
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ " http://localhost:8080/good-reader-email-verify/email-verification.html?token=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
	...
	final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>"
		      ...
		      + "<a href='http://localhost:8080/good-reader-email-verify/password-reset.html?token=$tokenValue'>"
		  ...
		  final String PASSWORD_RESET_TEXTBODY = "A request to reset your password "
		      ...
		      + " http://localhost:8080/good-reader-email-verify/password-reset.html?token=$tokenValue"
		      + " Thank you!";
